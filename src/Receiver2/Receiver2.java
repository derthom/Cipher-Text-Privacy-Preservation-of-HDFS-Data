...
//                st.executeUpdate("truncate table receiverdet");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Receiver 2");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(280, 10, 150, 40);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Receiver2 msr = new Receiver2();
            msr.generateRandomString();
            System.out.println("random id is" + msr.generateRandomString());
            long num1 = (rand.nextInt(8) + 1 * 1000) + (rand.nextInt(8) + 1) * 100 + (rand.nextInt(10) * 10) + rand.nextInt(10);
    ...
    public static void main(String args[]) {
        ...
        /*try {
            ...
            java.util.logging.Logger.getLogger(Receiver2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
