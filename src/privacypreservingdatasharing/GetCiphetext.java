...
public class GetCiphetext extends javax.swing.JFrame {

    public static String cat = DataSharing.cat, rd = DataSharing.rd;
    Connection con;
    Statement stat, st1, st;
    ...
    public GetCiphetext() {
        ...
        try {
            ...
            st.executeUpdate("truncate table ciphertext");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            rs = st.executeQuery("select metadata from cipher1 where diseasec LIKE '%" + cat + "%'");
            while (rs.next()) {
                int md = rs.getInt(1);
                System.out.println("metadata" + md);
                st1.executeUpdate("insert into metadata values('" + md + "') ");
            }
        ...
        try {
            rs = st.executeQuery("select * from cipher1 where diseasec LIKE '%" + cat + "%'");
//             rs = st.executeQuery("select * from cipher1 where diseasec='JSTcl6qqSLxGV/xCJvk8aVgsEf/k8lDJX6u0lc9KmM0='");
            while (rs.next()) {
                int md = rs.getInt(1);
                ...
                st1.executeUpdate("insert into  ciphertext values('" + md + "','" + name + "','" + age + "','" + gen + "','" + month + "','" + place + "','" + dise + "')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ServerSocket servsock = new ServerSocket(1112);
            File myFile = new File("./cipher.txt");
            while (true) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetCiphetext.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetCiphetext().setVisible(true);
            }
        });
    }
