...
public class GetCiphetext1 extends javax.swing.JFrame {

    public static String cat = DataSharing.cat1, rd = DataSharing.rd1;
    java.sql.Connection con;
    java.sql.Statement stat, st1, st;
    ResultSet rs, rs1, rs2, rs3;

    public GetCiphetext1() {
        initComponents();
        try {
            ...
            st.executeUpdate("truncate table metadata1");
            st.executeUpdate("truncate table ciphertext1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            while (rs.next()) {
                ...
                st.executeUpdate("insert into metadata1 values('" + md + "') ");
            }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                st1.executeUpdate("insert into  ciphertext1 values('" + md + "','" + name + "','" + age + "','" + gen + "','" + month + "','" + place + "','" + dise + "')");
                jTextArea1.append(md + "\t" + name + "\t" + age + "\t" + gen + "\t" + month + "\t" + place + "\t" + dise + "\n");
                String cont = jTextArea1.getText();
                BufferedWriter bw = new BufferedWriter(new FileWriter("./cipher1.txt"));
                bw.write(cont);
                bw.close();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            File myFile = new File("./cipher1.txt");
            while (true) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetCiphetext1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetCiphetext1().setVisible(true);
            }
        });
    }
